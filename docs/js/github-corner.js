const githubConrner = `
<a href="https://github.com/tomickigrzegorz/autocomplete" target="_blank" class="github-corner" aria-label="View source on GitHub" title="View source on GitHub"><svg height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github v-align-middle">
...
function detectUrl(file) {
  ...
  if (location.hostname === "localhost" || location.hostname === "127.0.0.1") {
    ...
    url = `https://tomickigrzegorz.github.io/autocomplete/data/${file}`;
  }
  return url;
}
