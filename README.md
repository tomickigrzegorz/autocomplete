...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/tomik23/autocomplete@1.7.6/dist/css/autocomplete.min.css"/>
```

#### JavaScript

```html
<script src="https://cdn.jsdelivr.net/gh/tomik23/autocomplete@1.7.6/dist/js/autocomplete.min.js"></script>
```
...
- https://cdn.jsdelivr.net/gh/tomik23/autocomplete@1.7.6/dist/js/polyfill.js
- https://cdn.jsdelivr.net/gh/tomik23/autocomplete@1.7.6/dist/js/autocomplete.ie.min.js
- https://cdn.jsdelivr.net/gh/tomik23/autocomplete@1.7.6/dist/css/autocomplete.ie.min.css
